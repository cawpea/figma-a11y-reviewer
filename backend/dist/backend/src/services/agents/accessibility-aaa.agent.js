...
exports.AccessibilityAAAAgent = void 0;
const prompt_utils_1 = require("../../utils/prompt.utils");
const base_agent_1 = require("./base.agent");
class AccessibilityAAAAgent extends base_agent_1.BaseEvaluationAgent {
    category = 'accessibility-aaa';
    systemPrompt = `あなたはWCAG 2.2 Level AAA基準に精通したアクセシビリティの専門家です。
...
exports.AccessibilityAAAAgent = AccessibilityAAAAgent;
