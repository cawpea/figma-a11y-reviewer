...
exports.AccessibilityAAgent = void 0;
const prompt_utils_1 = require("../../utils/prompt.utils");
const base_agent_1 = require("./base.agent");
class AccessibilityAAgent extends base_agent_1.BaseEvaluationAgent {
    category = 'accessibility-a';
    systemPrompt = `あなたはWCAG 2.2 Level A基準に精通したアクセシビリティの専門家です。
...
exports.AccessibilityAAgent = AccessibilityAAgent;
